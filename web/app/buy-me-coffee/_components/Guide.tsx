      ...
      <div className="gap-16 lg:flex">
        <main className="w-full flex-shrink-0 flex-grow xl:max-w-[900px]">
          ...
          <Section id="contract-summary">
            ...
            <ul>
              <li>Donation Feature: Allows users to send donations in the form of ETH to the contract owner.</li>
              <li>Message Feature: Besides donating, users can attach a personal message with their contribution.</li>
            </ul>

            <P>
              In essence, users operating within the tflite UI can seamlessly contribute ETH to the contract owner via
              the BuyMeACoffee.sol contract and further personalize their donation with a message.
            </P>
